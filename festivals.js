...
//
// 任意フィールド:
//   stalls : 屋台・露店の情報（省略時はカテゴリ別の既定文を自動表示）
//   image  : サムネイル画像のURL（自分で撮った写真や利用許諾のある画像を推奨。
//            省略時はカテゴリ別の絵文字サムネイルを表示。※他サイトの写真の直リンクは避ける）
window.FESTIVALS = [
  // ---------- 夏（7〜8月） ----------
  {
    id: "hotaru-sagisou",
  ...
  },
  {
    ...
    stalls: "両日とも露店あり（和太鼓・奉納演芸などの神賑行事）",
  ...
  // ---------- 冬（12〜1月） ----------
  {
    ...
    time: "9:00〜20:00",
    stalls: "700店以上の露店（骨董・古着・植木・古道具や名物「代官餅」など）",
